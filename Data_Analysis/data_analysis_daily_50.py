...
def bar_graph_daily_50():
    with open('daily_50_joined.json', 'r') as file:
        data = json.load(file)
    ...
    app.layout = html.Div([
        dcc.Graph(
            ...
            figure={
                ...
                'layout': go.Layout(
                    title='Nasa Images of the Day Based on Most Occurring Release Dates for Songs on the Top 50 Global Chart on Spotify',
